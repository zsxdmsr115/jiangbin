...
<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <DIV>
		<FORM name="postForm" onSubmit="return check()" action="doTopicAdd.jsp" method="POST"> 
			<INPUT type="hidden" name="boardid" value="<%=board.getBoardid()  %>"/>
			
			<DIV class="t">
				<TABLE cellSpacing="0" cellPadding="0" align="center" >
				    <TR>
					    <TD class="h" colSpan="3" align="center"><B>发表帖子</B></TD>
				    </TR>
				    ...
				    <TR class="tr3">
					    ...
					    <TH colSpan=2>
					        <DIV>	
						        <span><textarea  class="content" style="WIDTH: 500px;" name="content" rows="20" cols="90" tabIndex="2" ></textarea></span>
